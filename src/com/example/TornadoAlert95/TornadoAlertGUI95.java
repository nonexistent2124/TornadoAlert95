...
public class TornadoAlertGUI95 extends JFrame {
    ...
    private String mapConditionToIcon(String desc) {
        ...
        if (desc.contains("thunderstorm")) return "main/assets/thunderstorm.png";
        if (desc.contains("drizzle")) return "main/assets/rain.png";
        if (desc.contains("freezing rain") || desc.contains("rain") || desc.contains("shower"))
            return "main/assets/shower_rain.png";
        if (desc.contains("snow") || desc.contains("sleet")) return "main/assets/snow.png";
        if (desc.contains("mist") || desc.contains("haze") || desc.contains("fog") ||
                desc.contains("smoke") || desc.contains("dust") || desc.contains("tornado"))
            return "main/assets/mist.png";
        if (desc.equals("clear sky")) return "main/assets/clear_sky.png";
        if (desc.contains("overcast")) return "main/assets/broken_clouds.png";
        if (desc.contains("cloud")) return "main/assets/few_clouds.png";
        return "main/assets/default.png";
    }
